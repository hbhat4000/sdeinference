...
# xtraj1 = matrix(0, nrow = 40, ncol = 6)
# xtraj1 = google4[1:40,]

# xtraj2 = matrix(0, nrow = 40, ncol = 6)
# xtraj2 = google4[41:80,]
# xtraj2 = xtraj2[,1] - 144

# xtraj3 = matrix(0, nrow = 40, ncol = 6)
# xtraj3 = google4[81:120,]
# xtraj3 = xtraj3[,1] - xtraj3[1,1]
