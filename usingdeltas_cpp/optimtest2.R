...
res <- nloptr(x0 = theta, eval_f = objectfun, eval_grad_f = gradientfun, lb = c(0, 0, 0.1), ub = c(10, 10, 1.0), opts = list("algorithm"="NLOPT_LD_LBFGS", "print_level"=3, "check_derivatives" = TRUE, "xtol_rel"=1e-2))
