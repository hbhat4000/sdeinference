...
res <- nloptr(x0 = theta, eval_f = objgradfun, lb = c(0.1, 0.1), ub = c(10, 1.0), opts = list("algorithm"="NLOPT_LD_LBFGS", "print_level"=3, "check_derivatives" = TRUE, "xtol_abs"=1e-3))
