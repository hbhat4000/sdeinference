...
load('fakedata_vanderpol_fullres_new.RData')
...
mcmcsamples = matrix(0, nrow = totsteps, ncol = 2)
mcmcsamples[1,] = c(0.1,0.1)
thetavec = truethetavec
thetavec[2:3] = mcmcsamples[1,]
...
# save everything
save.image(file = 'samples_vdp_tby2_t23.RData')
