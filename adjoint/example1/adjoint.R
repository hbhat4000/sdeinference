...
gradobjfun <- function(c0, h, k, bigm, littlet, data, diffcoeff)
{
  ...
  # A is the kernel matrix K of the DTQ method without the factor of grid spacing k
  A = integrandmat(xvec, xvec, h, driftfun, difffun, c0, hermitefuncmat, diffcoeff)
  
  # D is a list of length(c0) matrices. Each matrix is the derivative of the kernel matrix K w.r.t. one parameter.
