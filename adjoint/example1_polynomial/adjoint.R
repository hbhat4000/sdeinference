...
# The drift function f is considered as an polynomial expansion
# The parameter vector c0 contains the coefficient of the polynomial expansion of the drift f
