...
result = nloptr(x0 = theta, eval_f = objgradfun, lb = -mybounds, ub = mybounds, opts = list("algorithm"="NLOPT_LD_LBFGS", "print_level"=3, "check_derivatives" = FALSE, "xtol_abs"=1e-3))
